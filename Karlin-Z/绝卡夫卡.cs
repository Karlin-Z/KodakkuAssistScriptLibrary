...
/// </summary>
[ScriptType(name: "绝凯夫卡", territorys: [1363], guid: "06cd8ccc-589d-46c4-8f50-36e3ca55919f", version: "0.0.0.4",
...
public class 绝凯夫卡
{
    ...
    private bool trueFire;

    [UserSetting("危险颜色2")] public ScriptColor dangerColor { get; set; } = new();

    [UserSetting("P1火分散延迟显示时间")] public int p1FireDelay { get; set; } = 2000;
    ...
    private ulong p1BossId;

    [ScriptMethod(EventTypeEnum.StartCasting, eventCondition: ["ActionId:48370"], userControl: false)]
    ...
    [ScriptMethod(EventTypeEnum.StartCasting, eventCondition: ["ActionId:50179"])]
    ...
    [ScriptMethod(EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(47768|47774)$"])]
    ...
    [ScriptMethod(EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(47775|47777)$"])]
    ...
    [ScriptMethod(EventTypeEnum.TargetIcon, eventCondition: ["Id:regex:^(02A1|02A2)$"], userControl: false)]
    public void P1_真假火收集(Event @event, ScriptAccessory accessory)
    {
        trueFire = @event["Id"] == "02A2";
    }

    [ScriptMethod(EventTypeEnum.TargetIcon, eventCondition: ["Id:0080"])]
    public void P1_真假火分摊处理(Event @event, ScriptAccessory accessory)
    {
        Task.Delay(50).ContinueWith(o =>
        {
            ...
            if (trueFire)
            {
                ...
                if (targetindex < 4 == myindex < 4) dp.Color = accessory.Data.DefaultSafeColor;
    ...
    [ScriptMethod(EventTypeEnum.TargetIcon, eventCondition: ["Id:007F"], suppress: 1000)]
    ...
    [ScriptMethod(EventTypeEnum.TargetIcon, eventCondition: ["Id:regex:^(0080|007F)$"])]
    ...
    [ScriptMethod(EventTypeEnum.VfxEvent, eventCondition: ["Type:Omen", "Id:737"])]
    public void P1_冰特效换色(Event @event, ScriptAccessory accessory)
    {
        var handle = nint.Parse(@event["Handle"], NumberStyles.HexNumber);
        accessory.Log.Debug($"特效捕获{@event["Handle"]}");
        var rot = float.Parse(@event["Rotation"]);
        Task.Delay(50).ContinueWith(t =>
        {
            accessory.Method.VfxMethod.SetVfxColorRGBA(handle, new Vector4(1, 1, 1, 0));
            //accessory.Method.VfxMethod.SetOmennPos(handle, new(100, 0, 100, rot>0? MathF.PI:-MathF.PI));
        });
    }


    [ScriptMethod(EventTypeEnum.Tether, eventCondition: ["Id:002D"])]
    ...
    private readonly object treadLock = new();

    [ScriptMethod(EventTypeEnum.ActionEffect, eventCondition: ["ActionId:47784", "TargetIndex:1"])]
    ...
    [ScriptMethod(EventTypeEnum.StatusAdd, eventCondition: ["StatusID:5078"])]
    ...
    [ScriptMethod(EventTypeEnum.ActionEffect, eventCondition: ["ActionId:50722"], suppress: 1000)]
    ...
    [ScriptMethod(EventTypeEnum.ObjectEffect, eventCondition: ["Id1:64", "Id2:128"])]
    ...
    [ScriptMethod(EventTypeEnum.StatusAdd, eventCondition: ["StatusID:regex:^(487[6789]|5079|508[012])$"],
        userControl: false)]
    ...
    public void P1_传送buff放置_指路(Event @event, ScriptAccessory accessory)
    {
        ...
        Task.Delay(100).ContinueWith(t =>
        {
            ...
            {
                case 13:
                    pos1 = new Vector3(106, 0, 91);
                    pos2 = new Vector3(100, 0, 91);
                    break;
                case 31:
                    pos1 = new Vector3(100, 0, 91);
                    pos2 = new Vector3(106, 0, 91);
                    break;
                case 14:
                    pos1 = new Vector3(91, 0, 100);
                    pos2 = new Vector3(91, 0, 94);
                    break;
                case 41:
                    pos1 = new Vector3(91, 0, 94);
                    pos2 = new Vector3(91, 0, 100);
                    break;
                case 23:
                    pos1 = new Vector3(109, 0, 100);
                    pos2 = new Vector3(109, 0, 106);
                    break;
                case 32:
                    pos1 = new Vector3(109, 0, 106);
                    pos2 = new Vector3(109, 0, 100);
                    break;
                case 24:
                    pos1 = new Vector3(94, 0, 109);
                    pos2 = new Vector3(100, 0, 109);
                    break;
                case 42:
                    pos1 = new Vector3(100, 0, 109);
                    pos2 = new Vector3(94, 0, 109);
                    break;
                case 11:
                    pos1 = new Vector3(115, 0, 100);
                    pos2 = new Vector3(115, 0, 106);
                    break;
                case 22:
                    pos1 = new Vector3(85, 0, 100);
                    pos2 = new Vector3(85, 0, 94);
                    break;
                case 33:
                    pos1 = new Vector3(100, 0, 115);
                    pos2 = new Vector3(94, 0, 115);
                    break;
                case 44:
                    pos1 = new Vector3(100, 0, 85);
                    pos2 = new Vector3(106, 0, 85);
                    break;
            }
    ...
    public static unsafe void WriteVisible(ScriptAccessory sa, IGameObject? actor, bool visible,
        int recoverInterval = 0)
    {
