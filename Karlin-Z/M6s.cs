...
[ScriptType(name: "M6s绘图", territorys: [1259], guid: "0146ff9b-1118-44e1-7386-e3b0795e7b60", version: "0.0.0.5",
...
public class M6sDraw
{
    ...
    private readonly List<int> StickyMousseTarget = [];
    ...
    [ScriptMethod(name: "P1 色彩狂热 死刑范围", eventType: EventTypeEnum.StartCasting,
        eventCondition: ["ActionId:regex:^(4264[12])$"])]
    ...
    [ScriptMethod(name: "P1 色彩狂热 死刑非T提醒", eventType: EventTypeEnum.StartCasting,
        eventCondition: ["ActionId:regex:^(4264[12])$"])]
    ...
    public void P1_黏黏慕斯怪_预站位(Event @event, ScriptAccessory accessory)
    {
        ...
        {
            myPoint = new Vector3(100, 0, 100);
        }
        else
        {
            if (myindex == 2) myPoint = RotatePoint(h1Point, new Vector3(100, 0, 100), 0);
            if (myindex == 3) myPoint = RotatePoint(h1Point, new Vector3(100, 0, 100), MathF.PI);
            if (myindex == 4) myPoint = RotatePoint(h1Point, new Vector3(100, 0, 100), -MathF.PI / 3);
            if (myindex == 5) myPoint = RotatePoint(h1Point, new Vector3(100, 0, 100), -MathF.PI / 3 * 2);
            if (myindex == 6) myPoint = RotatePoint(h1Point, new Vector3(100, 0, 100), MathF.PI / 3);
            if (myindex == 7) myPoint = RotatePoint(h1Point, new Vector3(100, 0, 100), MathF.PI / 3 * 2);
        }
    ...
    [ScriptMethod(name: "P1 黏黏慕斯怪 分摊范围", eventType: EventTypeEnum.ActionEffect,
        eventCondition: ["ActionId:42646", "TargetIndex:1"])]
    ...
    [ScriptMethod(name: "P3 动物园 第一轮拉怪位置", eventType: EventTypeEnum.StartCasting,
        eventCondition: ["ActionId:regex:^(42661)$"])]
    public void P3_动物园_第一轮拉怪位置(Event @event, ScriptAccessory accessory)
    {
        //13000ms
        var myIndex = accessory.Data.PartyList.IndexOf(accessory.Data.Me);
        Vector3 pos = new(93, 0, 100);
        if (myIndex == 0) pos = new Vector3(107, 0, 100);
        ...
        if (myIndex == 0)
        {
            ...
            dp.Color = accessory.Data.DefaultDangerColor;
            dp.Position = pos;
            dp.TargetPosition = new Vector3(100, 0, 110);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.DestoryAt = 13000;
            accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
    ...
    [ScriptMethod(name: "P3 动物园 第一轮选中羊", eventType: EventTypeEnum.Targetable,
        eventCondition: ["Targetable:True", "DataId:18344"])]
    ...
    [ScriptMethod(name: "P3 动物园 第二轮拉怪位置", eventType: EventTypeEnum.Targetable,
        eventCondition: ["Targetable:True", "DataId:18346"], suppress: 1000)]
    ...
    [ScriptMethod(name: "P3 动物园 第二轮选中鱼及引导初始", eventType: EventTypeEnum.Targetable,
    ...
    public void P3_动物园_第二轮选中鱼(Event @event, ScriptAccessory accessory)
    {
        ...
        if (zoo2Fish == zoo2FishEnum.Right && pos.X > 100)
        {
            ...
            dp.Color = accessory.Data.DefaultSafeColor;
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = new Vector3(105, 0, 80.5f);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.DestoryAt = 8000;
            accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
        }
        ...
        if (zoo2Fish == zoo2FishEnum.Left && pos.X < 100)
        {
            ...
            dp.Color = accessory.Data.DefaultSafeColor;
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = new Vector3(95, 0, 80.5f);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.DestoryAt = 8000;
            accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
        }
    ...
    [ScriptMethod(name: "P3 动物园 第三轮拉怪位置", eventType: EventTypeEnum.StartCasting,
        eventCondition: ["ActionId:regex:^(42664)$"])]
    public void P3_动物园_第三轮拉怪位置(Event @event, ScriptAccessory accessory)
    {
        ...
        if (myIndex == 1)
        {
            ...
            dp.Color = accessory.Data.DefaultSafeColor;
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = new Vector3(100, 0, 90);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.DestoryAt = 5000;
            accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
            ...
            dp.Color = accessory.Data.DefaultDangerColor;
            dp.Position = new Vector3(100, 0, 90);
            dp.TargetPosition = new Vector3(90, 0, 100);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.DestoryAt = 5000;
            accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
            ...
            dp.Color = accessory.Data.DefaultSafeColor;
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = new Vector3(110, 0, 100);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.Delay = 5000;
            dp.DestoryAt = 8000;
            accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
    ...
    [ScriptMethod(name: "P3 动物园 第三轮选中马", eventType: EventTypeEnum.Targetable,
    ...
    [ScriptMethod(name: "P3 动物园 第三轮眩晕马提示", eventType: EventTypeEnum.Targetable,
        eventCondition: ["Targetable:True", "DataId:18345"])]
    ...
    [ScriptMethod(name: "P3 动物园 第四轮拉怪位置", eventType: EventTypeEnum.StartCasting,
        eventCondition: ["ActionId:regex:^(42665)$"])]
    public void P3_动物园_第四轮拉怪位置(Event @event, ScriptAccessory accessory)
    {
        ...
        if (myIndex == 1)
        {
            ...
            dp.Name = "P3 动物园 第三轮拉怪位置 ST 2";
            dp.Color = accessory.Data.DefaultDangerColor;
            dp.Position = new Vector3(100, 0, 110);
            dp.TargetPosition = new Vector3(90, 0, 95);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.DestoryAt = 5000;
            accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
        ...
        if (myIndex == 0)
        {
            ...
            dp.Color = accessory.Data.DefaultDangerColor;
            dp.Position = new Vector3(100, 0, 110);
            dp.TargetPosition = new Vector3(110, 0, 105);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.DestoryAt = 5000;
            accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
    ...
    [ScriptMethod(name: "P3 动物园 第四轮选中鱼及引导初始", eventType: EventTypeEnum.Targetable,
        eventCondition: ["Targetable:True", "DataId:18346"])]
    public void P3_动物园_第四轮选中鱼(Event @event, ScriptAccessory accessory)
    {
        ...
        if (myindex == 7 && pos.X > 100)
        {
            ...
            dp.Color = accessory.Data.DefaultSafeColor;
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = new Vector3(118, 0, 80.5f);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.DestoryAt = 8000;
            accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
        }
        ...
        if (myindex == 6 && pos.X < 100)
        {
            ...
            dp.Color = accessory.Data.DefaultSafeColor;
            dp.Owner = accessory.Data.Me;
            dp.TargetPosition = new Vector3(80.5f, 0, 95f);
            dp.ScaleMode |= ScaleMode.YByDistance;
            dp.DestoryAt = 8000;
            accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
        }
    ...
    [ScriptMethod(name: "P3 动物园 第四轮选中马", eventType: EventTypeEnum.Targetable,
        eventCondition: ["Targetable:True", "DataId:18345"])]
    ...
    [ScriptMethod(name: "P3 动物园 第四轮眩晕马提示", eventType: EventTypeEnum.Targetable,
        eventCondition: ["Targetable:True", "DataId:18345"])]
    ...
    public void 剑连线(Event @event, ScriptAccessory accessory)
    {
        ...
        dp.Color = accessory.Data.DefaultDangerColor;
        dp.Scale = new Vector2(7, 45);
        dp.Owner = @event.SourceId;
        dp.DestoryAt = 7000;
        accessory.Method.SendDraw(DrawModeEnum.Vfx, DrawTypeEnum.Rect, dp);
    }

    [ScriptMethod(name: "P4 山川 阶段转换", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:42595"],
        userControl: false)]
    ...
    public void P4_山川_拉怪指示(Event @event, ScriptAccessory accessory)
    {
        ...
        dp.Color = accessory.Data.DefaultSafeColor;
        dp.Owner = accessory.Data.Me;
        dp.TargetPosition = new Vector3(90, 0, 108);
        dp.ScaleMode |= ScaleMode.YByDistance;
        dp.DestoryAt = 13000;
        accessory.Method.SendDraw(DrawModeEnum.Imgui, DrawTypeEnum.Displacement, dp);
    }
    ...
    [ScriptMethod(name: "P4 慕斯慕斯冲 近四人扇形", eventType: EventTypeEnum.StartCasting,
        eventCondition: ["ActionId:regex:^(42682)$"])]
    ...
    [ScriptMethod(name: "P4 慕斯慕斯冲 近四人扇形 诱导提醒", eventType: EventTypeEnum.StartCasting,
        eventCondition: ["ActionId:regex:^(42682)$"])]
    ...
    [ScriptMethod(name: "P4 糖糖闪雷 飞翎羽", eventType: EventTypeEnum.StartCasting,
        eventCondition: ["ActionId:regex:^(42653)$"])]
    ...
    [ScriptMethod(name: "P4 糖糖闪雷 飞翎羽踩塔提醒", eventType: EventTypeEnum.StartCasting,
        eventCondition: ["ActionId:regex:^(42653)$"], suppress: 1000)]
