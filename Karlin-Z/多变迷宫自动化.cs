...
[ScriptType(name: "多变迷宫自动化", territorys: [1069, 1137, 1176], guid: "ad122d3e-0966-48c8-bddb-a0a3e9fe3a61",
    version: "0.0.0.1", author: "Karlin")]
public class 多变迷宫自动化
{
    private DateTime lastdot = DateTime.Now;


    private DateTime lasthealth = DateTime.Now;

    [UserSetting("低于该值对自己使用治疗")] public int healthThreshold { get; set; } = 20000;

    [UserSetting("多变治疗栏位，左边为2右边为1")] public int healthSlot { get; set; } = 1;

    [UserSetting("Dot栏位，左边为2右边为1")] public int DotSlot { get; set; } = 1;
